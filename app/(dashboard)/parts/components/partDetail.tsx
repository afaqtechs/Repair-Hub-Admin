    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex items-start gap-3">
                ...
                <PageHeader
                    title={part.title}
                    description={`Manage ${part.title} part details.`}
                />
            </div>
                    ...
                    <div className="rounded-2xl bg-card p-6">
                        ...
                        {part.description ? (
                            <div className="whitespace-pre-line text-sm leading-7 text-gray-600">
                                <HTMLRenderer html={part.description} />
                            </div>
                        ) : (
                    ...
                    <div className="rounded-2xl bg-card p-6">
                        <div className="flex flex-wrap items-start justify-between gap-3">
                            ...
                            <div className="flex flex-wrap gap-2">
                                <span
                                    className={`rounded-full px-3 py-1 text-xs font-medium ${part.is_approved
                        ...
                        <div className="flex gap-3">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-sm text-gray-500">
                                    {part.is_approved
                                        ? "This spare part has been approved and is visible to users."
                                        : "This spare part is waiting for approval."}
                                </p>
                            </div>
                        </div>
                    </div>
